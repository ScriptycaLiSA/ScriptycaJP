...
<html lang="en">
<head>
	<title>Contact Developer! | Scriptyca, #1 Online Japanese Language Platform</title>
	<meta charset="utf-8">
...
<body>
	<nav class="navbar navbar-default">
      <div class="container-fluid">
        <div class="navbar-header">
          	<a class="navbar-brand" href="\ITPC-109-3B\index.html"><img class="rounded-circle" src="assets/resources/images/scriptyca.png" alt="navBrand"/ style="height: 50px; width: 50px;"></a>
		  	</div>
	...
	<nav class="navbar navbar-expand-md navbar-dark sticky-top">
		...
		<div class="container-fluid text-left">
			<p class="display-4">Contact Developer</p>
			<br>
		</div>
				<div class="card">
					<img src="assets/resources/images/dev_momo.jpg" class="thumbnail rounded rounded-circle mx-auto d-block" alt="dev_momo" style="width: 120px; height: 120px; margin: 10px">
					<div class="text-center">
						<p class="lead">Montizon, Jake G.</p>
						<p class="lead">Bachelor of Science in Information Technology 3-B</p>
					</div>
				</div>
	</body>
	</html>
