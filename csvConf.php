<!--Coded by Montizon, Jake G.
  ...
  $succMess="PROCESSED SUCCESSFULLY!";
  autoDelay();
   ?>
<!DOCTYPE HTML>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid">
    <p class="py-2 display-4 lead text-center"><?php echo htmlspecialchars($succMess) ?></p>
    <form method="get" action="assets/resources/new_file.csv">
      <div class="wrapper text-center">
        <p class="lead">YOU CAN DOWNLOAD THE INFORMATION BY
          <input type="submit" value="CLICKING THIS LINK!">
        </p>
        <p class="lead">Redirecting in a few seconds...</p>
      </div>
    </form>
  </div>
</body>
