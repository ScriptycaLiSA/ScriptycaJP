...
<body>
	...
	<div class="container-fluid text-left">
		<p class="display-4">Japanese Characters</p>
		<p class="lead">The three horsemen of Japanese Writing System</p>
		<br>
	</div>
	<div class="container text-center">
			<div class="row">
    			<div class="col-sm-4">
      				...
      				<h3>Hiragana</h3>
      				<p>Hiragana is a Japanese syllabary, one component of the Japanese writing system, along with katakana, kanji and in some cases Latin script. It is a phonetic lettering system. The word hiragana literally means "ordinary" or "simple" kana. Hiragana and katakana are both kana systems.</p>
					</div>
    			<div class="col-sm-4">
      				<span><img src="assets/resources/images/katakana.png" alt="katakana" class="rounded"></span>
      				<h3>Katakana</h3>
      				<p>Katakana is a Japanese syllabary, one component of the Japanese writing system along with hiragana, kanji and in some cases the Latin script. The word katakana means "fragmentary kana", as the katakana characters are derived from components or fragments of more complex kanji.</p>
    			</div>
    			<div class="col-sm-4">
    				<span><img src="assets/resources/images/kanji.png" alt="kanji" class="rounded"></span>
      				<h3>Kanji</h3>
      				<p>Kanji are the adopted logographic Chinese characters that are used in the Japanese writing system. They are used alongside the Japanese syllabic scripts hiragana and katakana. The Japanese term kanji for the Chinese characters literally means "Han characters".</p>
    			</div>
				</div>
		</div>
</body>
